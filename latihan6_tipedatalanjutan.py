...
print("                      KALIMAT                    ")
print("-------------------------------------------------")
print(kalimat[4],kalimat[9],kalimat[16],kalimat[2],kalimat[8],kalimat[5],kalimat[14],kalimat[10],kalimat[12],kalimat[11],kalimat[1],kalimat[6],kalimat[7],kalimat[1],kalimat[0],kalimat[15])
